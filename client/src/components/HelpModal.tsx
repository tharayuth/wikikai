    ...
    <div className="help-content">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Resize a diagram</td><td>Hover a Mermaid diagram and drag the handle on its <strong>right edge</strong>; the diagram scales to the width you pick (height follows its aspect ratio). Double-click the handle to go back to the natural size. Unlike the reading column, this is saved into the document — everyone who opens it, including via a share link, sees the size you chose</td></tr>
    ...
    <div className="help-content">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>ย่อ/ขยาย diagram</td><td>เอาเมาส์ชี้ที่ diagram (Mermaid) แล้วลากที่ <strong>ขอบขวา</strong> — diagram จะขยาย/ย่อตามความกว้างที่เลือก (ความสูงไปตามสัดส่วนเดิม). ดับเบิลคลิกที่ขอบเพื่อคืนขนาดปกติ. ต่างจากความกว้างคอลัมน์อ่านตรงที่ค่านี้ <strong>บันทึกลงในเอกสาร</strong> — ทุกคนที่เปิด รวมถึงคนที่เปิดผ่านลิงก์แชร์ จะเห็นขนาดเดียวกับที่คุณตั้ง</td></tr>
