    ...
    <div className="help-content">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Add a knowledge / page</td><td>Click the <strong>project id badge</strong> on a project header in the sidebar → <Kbd>New knowledge</Kbd> to create one in that project (the same menu copies the id, opens the project alone, or renames it). To add a <strong>page</strong>, click the <code>&amp;N</code> badge (sidebar topic row or topbar) → <Kbd>Add page</Kbd>. Both prompt for a title, then open the new entry</td></tr>
