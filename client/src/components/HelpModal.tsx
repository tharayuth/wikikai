    ...
    <div className="help-content">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>ปฏิทินของ project</td><td>คลิกป้ายเลข project ใน sidebar → <Kbd>Calendar</Kbd>. หน้าปฏิทินรายเดือนจะแสดงแทนพื้นที่เอกสาร แต่ละวันแสดง knowledge ที่มี page ถูกสร้างหรือแก้ในวันนั้น (ตัดวันตามเวลาของ browser). ตัวเลขท้ายชื่อคือจำนวน page ของวันนั้น — เป็นสีเขียวถ้ามีการสร้าง page ใหม่. <Kbd>Show pages</Kbd> จะแสดงรายการ page ในช่องวันด้วย: <strong>+</strong> สร้าง, <strong>✎</strong> แก้ไข, <code>×N</code> จำนวนครั้งที่เปลี่ยนในวันนั้น (browser จะจำค่าที่เลือก). คลิกวันเพื่อดูรายการทั้งหมด คลิกชื่อเพื่อเปิด และใช้ <Kbd>‹</Kbd> <Kbd>›</Kbd> / <Kbd>Today</Kbd> เปลี่ยนเดือน. ข้อมูลมาจาก activity log — page ที่ถูกลบไปแล้วจะไม่แสดง</td></tr>
