    ...
    <div className="help-content">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Share a topic publicly (no login)</td><td>Click the <code>&amp;N</code> badge → <Kbd>Share…</Kbd> to turn on a <strong>read-only public link</strong> (<code>/share/&lt;token&gt;</code>). Anyone with the link reads the document without logging in — no sidebar, no editing. Copy it, regenerate it (the old link stops working), or turn sharing off from the same dialog. Needs edit access to the topic's project</td></tr>
    ...
    <div className="help-content">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>แชร์ topic แบบ public (ไม่ต้องล็อกอิน)</td><td>คลิก badge <code>&amp;N</code> → <Kbd>Share…</Kbd> เพื่อเปิด <strong>ลิงก์ public อ่านอย่างเดียว</strong> (<code>/share/&lt;token&gt;</code>). ใครมีลิงก์ก็เปิดอ่านได้โดยไม่ต้องล็อกอิน — ไม่มี sidebar ไม่มีปุ่มแก้ไข. คัดลอก, สร้างลิงก์ใหม่ (ลิงก์เดิมใช้ไม่ได้), หรือปิดการแชร์ ได้จากหน้าต่างเดียวกัน. ต้องมีสิทธิ์ edit ใน project ของ topic นั้น</td></tr>
