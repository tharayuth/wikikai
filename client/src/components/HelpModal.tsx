    ...
    <div className="help-content">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Knowledge actions (copy / add page / edit / share / delete)</td><td>Click the <code>&amp;N</code> badge — in the topbar <strong>or</strong> on a sidebar topic row — to open the same menu: copy id, copy content, add page, rename, share, delete</td></tr>
    ...
    <div className="help-content">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>เมนู knowledge (คัดลอก / เพิ่ม page / แก้ชื่อ / แชร์ / ลบ)</td><td>คลิก badge <code>&amp;N</code> — ที่ topbar <strong>หรือ</strong> ที่แถว topic ใน sidebar — เปิดเมนูเดียวกัน: คัดลอก id, คัดลอกเนื้อหา, เพิ่ม page, แก้ชื่อ, แชร์, ลบ</td></tr>
