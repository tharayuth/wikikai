    ...
    <div className="login-page" lang="th">
      <div className="login-shell">
        <header className="login-header">
          ...
          <a className="login-github" href="https://github.com/tharayuth/wikikai" target="_blank" rel="noopener noreferrer">
        ...
        <main className="login-main">
          <section className="login-intro" aria-labelledby="login-heading">
            ...
            <figure className="login-illustration">
              <img src="/assets/login-knowledge.webp" alt="คนและ AI ช่วยกันเรียบเรียงเอกสารเป็นหนังสือความรู้" width="1536" height="1024" />
              <figcaption>AI + DOCUMENTS + PEOPLE</figcaption>
            </figure>
          </section>
